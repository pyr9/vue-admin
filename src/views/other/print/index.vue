<template>
    <PageWrapLayout>
        ...
        <el-descriptions title="配置项 " :column="1" border class="descriptions">
            <el-descriptions-item label="官方文档"><a href="https://github.com/crabbly/Print.js" target="_blank">https://github.com/crabbly/Print.js</a>
            </el-descriptions-item>
            <el-descriptions-item label="printable"> 文档来源：pdf或图像的url，html元素的id或json数据的对象
            </el-descriptions-item>
            <el-descriptions-item label="type"> 可打印类型。可用的打印选项包括：pdf，html，image，json和raw-html。
            </el-descriptions-item>
