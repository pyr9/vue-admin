<template>
    <PageWrapLayout>
        ...
        <div>
            <vue-qr :logoSrc="logoSrc" :text="inputData" :size="200" :callback="qrcodeCallback"
                    :color-dark="randomColor"></vue-qr>
        </div>

        <el-descriptions title="配置项 " :column="1" border class="descriptions">
            <el-descriptions-item label="官方文档"><a href="https://github.com/Binaryify/vue-qr" target="_blank">https://github.com/Binaryify/vue-qr</a>
            </el-descriptions-item>
            <el-descriptions-item label="text"> 二维码内容，默认为 'https://github.com/zouzhibin/vue-admin-perfect'
            </el-descriptions-item>
            ...
            <el-descriptions-item label="autoColor"> 若为 true, 背景图的主要颜色将作为实点的颜色, 即 colorDark,默认
                true
            </el-descriptions-item>
            ...
            <el-descriptions-item label="callback"> 生成的二维码 Data URI 可以在回调中取得,第一个参数为二维码 data URL,
                第二个参数为 props 传过来的 qid(因为二维码生成是异步的,所以加个 id 用于排序)
            </el-descriptions-item>
        </el-descriptions>
    </PageWrapLayout>
</template>
